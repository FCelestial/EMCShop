...
public class MainCommand implements CommandExecutor, TabExecutor {
    ...
    private void sendHelp(CommandSender sender) {
        ...
        sender.sendMessage(Component.text("/emcshop purchase - 打开物品重构菜单", NamedTextColor.YELLOW));
        ...
        sender.sendMessage(Component.text("/emcshop item - 查看手持物品的灵叶价值", NamedTextColor.AQUA));
        sender.sendMessage(Component.text("/emcshop reload - 重载等价交换配置 (管理员)", NamedTextColor.RED));
    }
